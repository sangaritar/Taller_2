...
static const _Player_Request_type_support_symbol_names_t _Player_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mi_robot_servicio, srv, Player_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mi_robot_servicio, srv, Player_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mi_robot_servicio, srv, Player_Request)() {
  return &::mi_robot_servicio::srv::rosidl_typesupport_c::Player_Request_message_type_support_handle;
}
...
static const _Player_Response_type_support_symbol_names_t _Player_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mi_robot_servicio, srv, Player_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mi_robot_servicio, srv, Player_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mi_robot_servicio, srv, Player_Response)() {
  return &::mi_robot_servicio::srv::rosidl_typesupport_c::Player_Response_message_type_support_handle;
}
...
static const _Player_type_support_symbol_names_t _Player_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mi_robot_servicio, srv, Player)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mi_robot_servicio, srv, Player)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mi_robot_servicio, srv, Player)() {
  return &::mi_robot_servicio::srv::rosidl_typesupport_c::Player_service_type_support_handle;
}
